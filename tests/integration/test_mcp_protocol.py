...
"""
    ...
    def test_mcp_call_tool_with_validation_error(self, mcp_server_process):
        ...
        assert 'validation' in response['error'].lower() or 'required' in response['error'].lower()
    ...
    def test_mcp_unsupported_method(self, mcp_server_process):
        ...
        assert response['ok'] is False
        assert 'unsupported' in response['error'].lower() or 'unknown' in response['error'].lower()
