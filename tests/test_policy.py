...
class TestPolicyLoader:
    ...
    def test_load_missing_tools_section(self, test_policy_file):
        ...
        policy_file = test_policy_file("test_no_tools.yaml", "config:\n  default_timeout_sec: 30")
    ...
    def test_load_invalid_tools_section(self, test_policy_file):
        ...
        policy_file = test_policy_file("test_invalid_tools.yaml", "tools: not_an_object")
        
        loader = PolicyLoader(str(policy_file))
        
        with pytest.raises(PolicyValidationError, match="'tools' section must be an object"):
            loader.load_policy()
...
"""
        ...
        with pytest.raises(PolicyValidationError, match="timeout_sec must be a positive integer"):
            loader.load_policy()
...
"""
        ...
        with pytest.raises(PolicyValidationError, match="timeout_sec exceeds maximum allowed"):
            loader.load_policy()
...
class TestSchemaValidator:
    ...
    def test_validate_missing_required_field(self):
        ...
        with pytest.raises(SchemaValidationError, match="Missing required field: message"):
            validator.validate_args(args, schema, "test_tool")
    ...
    def test_validate_wrong_type(self):
        ...
        with pytest.raises(SchemaValidationError, match="has invalid type.*Expected integer.*got str"):
            validator.validate_args(args, schema, "test_tool")
    ...
    def test_validate_pattern_mismatch(self):
        ...
        with pytest.raises(SchemaValidationError, match="does not match required pattern"):
            validator.validate_args(args, schema, "test_tool")
    ...
    def test_validate_min_items_violation(self):
        ...
        with pytest.raises(SchemaValidationError, match="must have at least 2 items.*Got 1 items"):
            validator.validate_args(args, schema, "test_tool")
    ...
    def test_validate_max_length_violation(self):
        ...
        schema = {
            "type": "object",
            "properties": {
                "short_text": {"type": "string", "maxLength": 5}
            }
        }
        args = {"short_text": "this_is_too_long"}
        
        with pytest.raises(SchemaValidationError, match="exceeds maximum length of 5.*Got 16 characters"):
            validator.validate_args(args, schema, "test_tool")
    ...
    def test_validate_additional_properties_forbidden(self):
        ...
        with pytest.raises(SchemaValidationError, match="contains unexpected properties"):
            validator.validate_args(args, schema, "test_tool")
...
"""
    ...
    def test_registry_operations_before_initialization(self, test_policy_file, sample_policy_yaml: str):
