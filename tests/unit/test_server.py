...
class TestMCPResponse:
    ...
    def test_success_response_creation(self):
        ...
        response = MCPResponse.create_success(
            summary="Test completed", data={"result": "success"}, stdout="Test output"
        )
    ...
    def test_error_response_creation(self):
        ...
        response = MCPResponse.create_error(
            error_msg="Test failed", summary="Operation failed", exit_code=1
        )
    ...
    def test_response_serialization(self):
        ...
        response = MCPResponse.create_success(
            summary="Test completed", data={"test": True}
        )
    ...
    def test_output_truncation(self):
        ...
        response = MCPResponse(ok=True, stdout=long_output)
