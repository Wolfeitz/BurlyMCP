...
class WebhookNotificationProvider(NotificationProvider):
    ...
    def __init__(self, webhook_url: Optional[str] = None, headers: Optional[Dict[str, str]] = None):
        """
...
class NotificationManager:
    ...
    def send_notification(self, notification: NotificationMessage) -> bool:
        ...
        if success_count > 0:
            ...
            logger.warning(f"All notification providers failed for: {notification.title}")
            return False
    ...
    def _initialize_providers(self) -> None:
        ...
        provider_config = os.environ.get("NOTIFICATION_PROVIDERS", "console,gotify").lower()
        ...
        for provider_name in provider_names:
            ...
            if provider and provider.is_available():
                ...
                logger.warning(f"Notification provider '{provider_name}' not available (check configuration)")
            else:
